...
readxl::read_xlsx("./data/bronze_age_civilization.xlsx", skip = 1) %>% 
  knitr::kable(caption = "A summary of eras representing Bronze age civilization", booktabs = TRUE, longtable = TRUE) %>% 
...
read_csv('./data/world_war_first_1914-22_timeline.csv') %>% 
  ...
  kableExtra::column_spec(column = 2:3, width = c("10em", "26em"))
...
read_csv('./data/world_top_spoken_languages.csv') %>% 
  ...
  kableExtra::kable_styling(latex_options = "striped") %>% 
  kableExtra::column_spec(column = 1:5, width = c("1.5em", "6em", "5em", "8em", "12em"))
```
...
read_csv("./data/world_highest_military_decorations_countrywise.csv") %>% 
  ...
  kableExtra::column_spec(column = 1:5, width = c("4em", "6em", "5em", "5em", "12em"))
```
